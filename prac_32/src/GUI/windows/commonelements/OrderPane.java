        ...
        MenuItemPanel(int tNum){
            ...
            cb.addItemListener(e->{
                if(cb.getSelectedIndex() == 1 && dt == null){
                    ...
                    JLabel l = new JLabel("Drink type: ");
                    l.setLabelFor(dt);
                    tf = new JTextField();
                    var l2 = new JLabel("Alcohol: ");
                    l2.setLabelFor(tf);
            ...
            if(tNum>0){
                var add = new JButton("Add to order");
                add.addActionListener(e-> GUI.getInstance().addToOrder(getData(), tNum));
